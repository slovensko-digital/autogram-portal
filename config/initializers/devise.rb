...
Devise.setup do |config|
  ...
  # config.secret_key = 'd5353742413521e4d31b32426252620d7db365747644f38edce0d0558b1b25c3b470abcc056cd9b07ccdfe823ea49f4aa3c0f2e81c8c66719d56859e4029a83e'
  ...
  config.mailer_sender = ENV.fetch("MAIL_FROM", "please-change-me-at-config-initializers-devise@example.com")
  ...
  # config.pepper = 'af853cde401ee97df28ac51e9c91e956d7080a6997bd1e70e7b24e50e4f90bdf0fa33e4ae0e62e77640865f0a22062de4745e85e75fec57d311c325a12c95f4f'
  ...
  config.omniauth :google_oauth2, ENV.fetch("GOOGLE_CLIENT_ID", nil), ENV.fetch("GOOGLE_CLIENT_SECRET", nil), scope: "userinfo.email,userinfo.profile"

  # Configure the OmniAuth path prefix to use /auth instead of /users/auth
